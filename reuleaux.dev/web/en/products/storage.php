	...
	<body>
		...
		<div id="flex">
			<div id="bodyTop">
				...
				<a class="bodyTopButton bodyTopActive"href="products/storage">Storage</a>
			</div>
			<div id="bodyBottom">
			...
			<table id="table-component">
                                ...
                                <tr>
                                        <td><a href="products/temp?c=storage&id=<?php echo$rows['storage_id']?>">
                                               <?php echo$rows['storage_name'];?></a></td>
                                        <td><?php echo$rows['storage_manufacturer']?></td>
                                        <td><?php echo$rows['storage_capacity']?></td>
                                        <td><?php echo$rows['storage_type']?></td>
                                        <td>$<?php echo$rows['storage_price']?><td>
                                </tr>
                                <?php } ?>
                        </table>
			<!-- table end -->
