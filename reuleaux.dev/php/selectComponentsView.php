...
.button2 {background-color: #008CBA;} /* Blue */
	...
	<body>
       ...
       <a href=home>
		...
		<hr class="hrGray">
		<div id="headerBottom">
			<a class="headerButton1"href=../../php/viewCPU.php>
				<p class="headerButton2">Show CPU Database</p>
			</a><a class="headerButton1"href=../../php/viewGPU.php>
				<p class="headerButton2">Show GPU Database</p>
			</a><a class="headerButton1"onclick="toggleTable()">
		...
		<table id="myTable" style="width:50%" class="hidden">
            ...
            <tr>
				...
				<td> 
				<button onclick="location.href='https://reuleaux.dev/home'" class="button button1"> add </button>
				</td>
            </tr>
            <?php
                }
